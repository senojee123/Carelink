    ...
    <div className="form-page">
      <div className="form-page-header">
        <div>
          ...
          <div className="page-sub">Add a new family member to your care list</div>
        </div>
            ...
            <div onClick={() => fileInputRef.current?.click()}>
              {photoPreview
                ...
                : <div className="photo-placeholder-circle">
                    <span className="photo-camera-emoji" style={{ display: 'flex', alignItems: 'center' }}><Camera size={28} /></span>
